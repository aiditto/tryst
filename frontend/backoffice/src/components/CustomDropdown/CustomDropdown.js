...
import styles from "assets/jss/aiditto-pro-style/components/customDropdownStyle.js";
  ...
  const dropDownMenu = (
    <MenuList role="menu" className={classes.menuList}>
      ...
      {dropdownList.map((prop, key) => {
        ...
        // This modifies the languages in the drop down (those not currently selected)
        return props.languageSelector ? (
  ...
  return (
    <div className={innerDropDown ? classes.innerManager : classes.manager}>
      <div className={buttonText !== undefined ? "" : classes.target}>
        <Button
          className={languageSelector ? classes.languageSelectorButton : classes.dropDownButton}
          ...
          onClick={handleClick}
        >
          {/* modify this buttonText to modify currently selected language*/}
          {getFlagIcon(buttonText)}
      ...
      <Popper
        ...
        className={classNames({
          [classes.itemStyle]: itemDialog,
          [classes.languageSelectorStyle]: languageSelector,
