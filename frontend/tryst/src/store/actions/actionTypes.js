...
export const GET_USERSITE_LIST = "[UserSite] Get UserSite List";
export const GET_USERSITE_LIST_SUCCESS = "[UserSite] Get UserSite List Success";
export const GET_USERSITE_LIST_FAILURE = "[UserSite] Get UserSite List Failed";
...
export const CREATE_RESPONSE = "[Response] Create Response";
export const CREATE_RESPONSE_SUCCESS = "[Response] Create Response Success";
export const CREATE_RESPONSE_FAILURE = "[Response] Create Response Failed";
export const GET_RESPONSE = "[Response] Get Response";
export const GET_RESPONSE_SUCCESS = "[Response] Get Response Success";
export const GET_RESPONSE_FAILURE = "[Response] Get Response Failed";
